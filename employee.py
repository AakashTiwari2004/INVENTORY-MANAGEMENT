...
class employeeClass:
 def __init__(self,root):
     ...
     #===searchFrame=====
     SearchFrame=LabelFrame(self.root,text="Search Employee",font=("goudy old style",12,"bold"),bd=2,relief=RIDGE,bg='orange')
     ...
     #===title====
     title=Label(self.root,text="Employee Details",font=("goudy old style",15),bg="red",fg="white").place(x=50,y=109,width=1000)
     
     #=====content======
     #===row1====
     lbl_empid=Label(self.root,text="Emp ID",font=("goudy old style",15),bg="orange").place(x=50,y=150)
     lbl_gender=Label(self.root,text="Gender",font=("goudy old style",15),bg="orange").place(x=350,y=150)
     lbl_contact=Label(self.root,text="Contact",font=("goudy old style",15),bg="orange").place(x=750,y=150)
     ...
     #===row2====
     lbl_name=Label(self.root,text="Name",font=("goudy old style",15),bg="orange").place(x=50,y=190)
     lbl_dob=Label(self.root,text="D.O.B",font=("goudy old style",15),bg="orange").place(x=350,y=190)
     lbl_doj=Label(self.root,text="D.O.J",font=("goudy old style",15),bg="orange").place(x=750,y=190)
     ...
     #===row3====
     lbl_email=Label(self.root,text="Email",font=("goudy old style",15),bg="orange").place(x=50,y=230)
     lbl_pass=Label(self.root,text="Password",font=("goudy old style",15),bg="orange").place(x=350,y=230)
     lbl_utype=Label(self.root,text="User Type",font=("goudy old style",15),bg="orange").place(x=750,y=230)
     ...
     #===row4====
     lbl_address=Label(self.root,text="Address",font=("goudy old style",15),bg="orange").place(x=50,y=270)
     lbl_salary=Label(self.root,text="Salary",font=("goudy old style",15),bg="orange").place(x=500,y=270)
